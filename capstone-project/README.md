...
## 3. Case Study: ITIL v5 Monitoring and Event Management Practice
...
The distributed architecture presented in this work provides a scalable foundation for enterprise IT operations automation while maintaining the flexibility to integrate with existing ITSM tools and processes. The successful validation of automated request routing and agent coordination demonstrates the viability of multi-agent systems for complex Digital Product and Service Management (DPSM) scenarios, paving the way for broader adoption of Agentic AIOps in production environments.
